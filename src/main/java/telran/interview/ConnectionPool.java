...
/**
 * Connection pool comprises some number of connections
 * It cannot contain more than the predefined number of connection
 ...
 * Policy should take in consideration the order of adding connections in pool and using connection
 */
